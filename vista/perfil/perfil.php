...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="../mensajeria/mensajeria.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Messages"><i class="fa fa-envelope"></i></a>
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          ...
          <div id="Demo1" class="w3-hide w3-container">
            <p><a href="../analiticas/analiticas.php">Analiticas</a></p>
          </div>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half">
              ...
              <img src="../../images/livingroom.jpg" style="width:100%" alt="Northern Lights" class="w3-margin-bottom">
			  </a>
            </div>
            <div class="w3-half">
              <img src="../../images/diningroom.jpg" style="width:100%" alt="Nature" class="w3-margin-bottom">
          </div>
        </div>
